...
Follow that SKILL.md's full process. Do not skip the upfront questions. Ask product job, track, or direction before any code when unclear. State the chosen route at the top of the response. Then implement.
